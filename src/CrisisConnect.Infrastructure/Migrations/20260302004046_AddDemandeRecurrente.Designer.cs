...
namespace CrisisConnect.Infrastructure.Migrations
{
    ...
    [Migration("20260302004046_AddDemandeRecurrente")]
    partial class AddDemandeRecurrente
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CrisisConnect.Domain.Entities.Demande", b =>
                {
                    ...
                    b.Property<bool>("EstRecurrente")
                        ...
                        .HasColumnName("est_recurrente");

                    b.Property<string>("FrequenceRecurrence")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("frequence_recurrence");
